...
public class ItemHeadlampGlowstone extends ItemFlashlightGlowstone{
	
	public ItemHeadlampGlowstone(){
		super("HeadlampGlowstone");
    ...
    public void loadCrafting(){
    	...
    	GameRegistry.addShapedRecipe(new ItemStack(this), new Object[]{
    		...
    		'f', new ItemStack((Item) Gizmos.content.get("flashlightGlowstone"))
    	});
    }
