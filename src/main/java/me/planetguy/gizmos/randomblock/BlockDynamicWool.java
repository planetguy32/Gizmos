package me.planetguy.gizmos.randomblock;
...
public class BlockDynamicWool extends Block{
	...
	public BlockDynamicWool(){
		...
		SLItemBlock.registerString(this, 0, "Dynamic wool", new String[]{"Redstone makes it", "change colours"});
		try {
			getSignalStrength=BlockRedstoneDiode.class.getDeclaredMethod("getInputStrength", World.class, int.class, int.class, int.class, int.class);
