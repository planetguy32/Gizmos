...
public class BlockSuperFire extends Block {
    ...
    */
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (par1World.getGameRules().hasRule("doFireTick"))
        {
    ...
    private void tryToCatchBlockOnFire(World par1World, int par2, int par3, int par4, int par5, Random par6Random, int par7, ForgeDirection face)
    {
        ...
        {
        	par1World.setBlockAndMetadataWithNotify(par2, par3, par4, this.blockID, 15);
        } 
    }
